package com.example.apphelper2019.ex.volley_ex;
...
public class Main2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        networkImageView.setErrorImageResId(R.drawable.ic_error_black_24dp);
        ...
        queue.addRequestFinishedListener(new RequestQueue.RequestFinishedListener<Object>() {
            ...
            public void onRequestFinished(Request<Object> request) {
                ...
                if (numberOfRequestsCompleted == 2) {
                    numberOfRequestsCompleted = 0;
                    startActivity(new Intent(Main2Activity.this, RecyclerViewActivity.class).putExtra("users", mUserDataList));
                }
            }
        });
    ...
    private void imageLoader() {
        ...
        imageLoader.get(IMAGE_URL, ImageLoader.getImageListener(
                networkImageView, R.mipmap.ic_launcher, R.drawable.ic_error_black_24dp));
    }
